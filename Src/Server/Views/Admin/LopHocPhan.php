...
?>
<h1 class="text-center p-4 fw-bold">Lớp Học Phần</h1>

<div class="d-flex gap-2 p-2 justify-content-end">

    <a class="btn btn-primary" href="/Admin/EditLopHocPhan">Thêm lớp học phần</a>
                    ...
                    <section class="m-auto bg-white p-4 rounded-4 text-dark">
                        <table class="table table-striped">
                            ...
                            foreach ($data["data"] as $index => $datum) {
                                ...
                                $delete = "";
                                $edit = <<<wut
                                    <a href="/Admin/EditLopHocPhan/{$datum["ID_DSMH"]}" class="btn btn-primary">Chỉnh</a>
                                wut;
                                if ($datum["CAN_DELETE"] == 1) {
                                    $delete = <<<wut
                                    <a href="/Admin/DeleteLopHocPhan/{$datum["ID_DSMH"]}" class="btn btn-danger">Xóa</a>
                                wut;
                                }
                                echo <<<JIT
                            <tr>
